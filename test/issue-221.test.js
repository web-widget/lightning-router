...
test('Should return correct param after switching from static route', (t) => {
  ...
  t.assert.deepEqual(findMyWay.find('GET', '/prefix-1111').params, {
    id: '1111'
  })
})
...
test('Should return correct param after switching from static route', (t) => {
  ...
  t.assert.deepEqual(findMyWay.find('GET', '/prefix-1111/hello').params, {
    id: '1111'
  })
})
...
test('Should return correct params after switching from parametric route', (t) => {
  ...
  findMyWay.on(
    'GET',
    '/test/:param1/test/:param2/prefix-:id/hello',
    () => {}
  )
  findMyWay.on('GET', '/test/:param1/test/:param2/:id', () => {})

  t.assert.deepEqual(
    findMyWay.find('GET', '/test/value1/test/value2/prefix-1111-hello')
      .params,
    {
      param1: 'value1',
      param2: 'value2',
