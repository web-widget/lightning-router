...
import httpMethodStrategy from './strategies/http-method.js'
...
class HandlerStorage {
  ...
  _compileGetHandlerMatchingConstraints (constrainer) {
    ...
    this._getHandlerMatchingConstraints = new Function( // eslint-disable-line no-new-func
      'derivedConstraints',
      lines.join('\n')
    )
  }
